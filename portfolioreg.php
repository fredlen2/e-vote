                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="voterupdate.php">Update Voter</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="">Others</a>
                    ...
                    <!-- <div class="box">  -->           
                            <div id="content">
                                 <?php
                                    ...
                                    if (isset($_POST['PortfolioReg'])) {
                                        
                                        $PortfolioName = $_POST['PortfolioName'];
                                          
                                         //$query = "INSERT INTO hallportfolios VALUES('', '$PortfolioName', '')";                   
                                        $query = "INSERT INTO portfolios VALUES('', '$PortfolioName', '')";
                                        $result = mysql_query($query,$connect) or die(mysql_error());
                                        echo "<font color='blue'>Portfolio successfully Registered!</font>";
                                        echo "<script language='javascript'>
                                                alert messsage('Portfolio successfully Registered!','success'); 
                                            </script>";
                                    }
                                ...
                                <form role="form" method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
                                    <fieldset>
                                        <div class="form-group input-group">
                                         ...
                                         <div class="form-group ">
                                            <div class="row container">
                                                <label for="PortfolioName" class="control-label">Portfolio Name</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="PortfolioName" placeholder="Portfolio Name" autofocus>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <button href="index.html" class="btn btn-lg btn-success btn-block" type="submit" name="PortfolioReg">Create Portfolio</button>
                                        </div>
