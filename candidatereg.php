                                ...
                                <?php
                                    if (isset($_POST['candidatereg'])) {
                                        ...
                                        if(getimagesize($_FILES['image']['tmp_name']) == FALSE)
                                        {
                                            ...
                                            echo "<script>
                                                    setTimeout(\"location.href = 'candidatereg.php';\",2000);
                                                  </script>";
                                        }
                                        else 
                                        {
                                            ...
                                            $query = "INSERT INTO candidates VALUES('', '$FirstName', '$LastName', '$Gender', '$Portfolio', '$Hall', '$name', '$image', '$date')";
                                         ...
                                         <div class="form-group ">
                                            ...
                                            <div class="row container">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <?php
                                                        $query = "SELECT PortfolioID, Pname FROM portfolios ORDER BY Pname ASC";
                                                        $result = mysql_query($query,$connect) or die(mysql_error());
